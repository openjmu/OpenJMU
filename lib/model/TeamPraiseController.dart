...
class TeamPraiseList extends StatefulWidget {
  ...
  TeamPraiseList(this._praiseController,
...
class _TeamPraiseListState extends State<TeamPraiseList>
  ...
  Future<Null> _loadData() async {
    ...
    if (!_isLoading && _canLoadMore) {
      ...
      for (var praiseData in _topics)
        praiseList.add(TeamPraiseAPI.createPraise(praiseData));
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: UserAPI.getAvatarProvider(
                uid: int.parse(praise['uid'].toString())),
            fit: BoxFit.cover,
          ),
        ),
      ),
