...
class TeamPostList extends StatefulWidget {
  ...
  TeamPostList(this._teamPostController,
...
class _TeamPostListState extends State<TeamPostList>
        ...
        _itemList = ListView.separated(
          ...
          itemBuilder: (context, index) {
            if (index == _postList.length) {
              ...
              return TeamPostCard(_postList[index],
                  fromPage: "team", index: index, isDetail: false);
            } else {
              return Container();
            }
          },
