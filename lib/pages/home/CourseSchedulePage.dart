...
class CourseSchedulePageState extends State<CourseSchedulePage>
            ...
            child: Container(
                ...
                child: DecoratedBox(
                    decoration: BoxDecoration(
                        ...
                        border: (DateAPI.currentWeek == index + 1 && currentWeek != DateAPI.currentWeek)
                                ?
                        Border.all(
    ...
    Widget get remarkWidget => AnimatedContainer(
        ...
        color: showWeek ? Theme.of(context).primaryColor : Theme.of(context).canvasColor,
        child: Center(
            child: RichText(
                text: TextSpan(
                    children: <InlineSpan>[
        ...
        return Expanded(
            ...
            child: Column(
                children: <Widget>[
                                    ...
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: courseList.isNotEmpty
                                                    ...
                                                    ? ThemeUtils.isDark ? course.color.withAlpha(200) : course.color
                                                    : Theme.of(context).dividerColor
                                                    : null,
                                        ),
                                        child: SizedBox.expand(
                                            child: course != null ? RichText(
                                                text: TextSpan(
                                                    children: <InlineSpan>[
                    ...
                    if (!currentIsEleven && isEleven) Expanded(
                        flex: 1,
                        child: SizedBox(),
                    ),
                ],
...
class CoursesDialog extends StatelessWidget {
    ...
    Widget courseDetail(Course course) => DecoratedBox(
        decoration: BoxDecoration(
            ...
            color: courseList.isNotEmpty
                    ? CourseAPI.inCurrentWeek(course, currentWeek: currentWeek)
                    ? ThemeUtils.isDark ? course.color.withAlpha(darkModeAlpha) : course.color
                    : Colors.grey
                    : null
            ,
        ),
                ...
                child: RichText(
                    text: TextSpan(
                        children: <InlineSpan>[
                            ...
                            if (course.teacher != null) TextSpan(text: "🎓 ${course.teacher}"),
                        ],
                        style: TextStyle(
                            color: Colors.black,
                            fontSize: Constants.suSetSp(20.0),
