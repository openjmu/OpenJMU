...
class TeamPostDetailPageState extends State<TeamPostDetailPage> {
  ...
  TeamCommentListInPostController _controller =
      TeamCommentListInPostController();
  ...
  void initState() {
    ...
    _post = TeamPostCard(widget.post,
          ...
          Row(
            children: <Widget>[
              MaterialButton(
                ...
                onPressed: () {
                  setCurrentTabActive(context, 0, "comments");
                },
              ),
              ...
              MaterialButton(
                ...
                onPressed: () {
                  setCurrentTabActive(context, 1, "praises");
                },
              ),
            ],
          ),
