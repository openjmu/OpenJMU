            ...
            children: <Widget>[
              ...
              Center(child: Container(
                  ...
                  child: RichText(text: TextSpan(children: <TextSpan>[
                    TextSpan(text: "OpenJmu has new version", style: TextStyle(fontFamily: 'chocolate',color: Colors.white, fontSize: 24.0)),
                  ]))
              )),
              Center(child: Container(
                  margin: EdgeInsets.symmetric(vertical: 6.0),
                  child: RichText(text: TextSpan(children: <TextSpan>[
                    TextSpan(text: "${event.currentVersion} -> ${event.response['version']}", style: TextStyle(fontFamily: 'chocolate',color: Colors.white, fontSize: 20.0)),
                  ]))
              )),
              RichText(
                  text: TextSpan(
