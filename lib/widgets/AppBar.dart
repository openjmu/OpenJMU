...
//        setState(() {
//          onPressAvatar = () {
//            UserPage.jump(context, UserAPI.curUser.id);
//          };
//        });
//      }
//    } else {
...
//
//    _checkLoginState();
//    Event.bus.on<UserStateChangeEvent>().listen((event) {
//      if (mounted) {
//        setState(() {
//          if (event.user == null) {
//            onPressAvatar = () {
...
//  Widget build(BuildContext context) {
//    var imageProvider =
//        (UserAPI.curUser == null || UserAPI.curUser.avatar == null)
//            ? AssetImage('assets/default_head.jpg')
//            : CachedNetworkImageProvider(UserAPI.curUser.avatar,
...
//                begin: 1.5, /*end: 1.0*/ end: 20.0 / widget.titleFontSize)
//            .transform(t);
...
//            EdgeInsetsDirectional.only(
//                start: paddingXScaleValue, bottom: paddingYScaleValue);
//
//        children.add(Positioned(
//            left: 16.0,
