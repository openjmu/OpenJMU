...
import 'package:openjmu/api/user_api.dart';
...
class API {
  ...
  static final firstDayOfTerm = "https://project.alexv525.com/openjmu/first-day-of-term";
  static final checkUpdate = "https://project.alexv525.com/openjmu/latest-version";
  static final latestAndroid = "https://project.alexv525.com/openjmu/openjmu-latest.apk";
  static final announcement = "https://project.alexv525.com/openjmu/announcement";
  ...
  static final newsDetail = "$middle99Host/mg/api/aid/posts_detail/post_type/3/post_id/";
  ...
  static final courseScheduleCourses = "$labsHost/courseSchedule/StudentCourseSchedule";
  static final courseScheduleClassRemark = "$labsHost/courseSchedule/StudentClassRemark";
  static final courseScheduleTermLists = "$labsHost/courseSchedule/GetSemesters";
  static final courseScheduleCustom = "$labsHost/courseSchedule/StudentCustomSchedule";
  ...
  static final jwglStudentScoreAll = "$jwglHost/Student/ScoreCourse/ScoreAll.aspx";
